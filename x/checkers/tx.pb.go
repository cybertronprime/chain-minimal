...
func (*ReqCheckersTorram) Descriptor() ([]byte, []int) {
	return fileDescriptor_468197949086b964, []int{0}
}
...
func (*ResCheckersTorram) Descriptor() ([]byte, []int) {
	return fileDescriptor_468197949086b964, []int{1}
}
...
func init() {
	proto.RegisterType((*ReqCheckersTorram)(nil), "checkers.v1.ReqCheckersTorram")
	proto.RegisterType((*ResCheckersTorram)(nil), "checkers.v1.ResCheckersTorram")
}

func init() { proto.RegisterFile("checkers/v1/tx.proto", fileDescriptor_468197949086b964) }

var fileDescriptor_468197949086b964 = []byte{
	// 324 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *checkersTorramClient) CheckersCreateGm(ctx context.Context, in *ReqCheckersTorram, opts ...grpc.CallOption) (*ResCheckersTorram, error) {
	...
	err := c.cc.Invoke(ctx, "/checkers.v1.CheckersTorram/CheckersCreateGm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CheckersTorram_CheckersCreateGm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkers.v1.CheckersTorram/CheckersCreateGm",
	}
...
var _CheckersTorram_serviceDesc = grpc.ServiceDesc{
	ServiceName: "checkers.v1.CheckersTorram",
